...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="tab-div">
			<!-- tab body -->
			<div id="tabbody-div">
				<form action="<?php echo site_url('admin/advertiser/add_action'); ?>" method="post" name="theForm">
					<table width="90%" id="general-table" align="center">
						<tbody>
							<tr>
								<td class="label">商家名称：</td>
								<td>
									<input type="text" name="advertiser_name" value="" style="float:left;color:;" size="30">
							...
							<tr>
								...
								<td>
									<input type="text" name="business" value="" style="float:left;color:;" size="30">
									<span class="require-field">*</span>
								</td>
							</tr>
							<tr>
								...
								<td>
									<input type="text" name="phone" value="" style="float:left;color:;" size="30">
									<span class="require-field">*</span>
								</td>
							</tr>
							<tr>
								...
								<td>
									<input type="text" name="qq" value="" style="float:left;color:;" size="30">
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									<input type="text" name="website" value="http://" style="float:left;color:;" size="30">
								</td>
							</tr>
							<tr>
