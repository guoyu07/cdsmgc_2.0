...
<HTML xmlns="http://www.w3.org/1999/xhtml">
	...
	<BODY>
		...
		<DIV class=form-div>
			<FORM method=post name=theForm action="<?php echo site_url('admin/category/add_advertiser');?>">
    				...
    				<TD class=first-cell align=left>
    					<SPAN><?php echo $row->name;?></SPAN> 
      					<SPAN class=link-span>
      						...
      						<A title=删除  onclick="javascript:confirm('你确认删除此条记录吗？')" href="<?php echo site_url('admin/category/delete_advertiser/'.$row->id); ?>">删除</A> 
      					</SPAN>
      				</TD>
      		<?php
      				$i++;
