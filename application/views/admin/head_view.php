...
<div id="header-div">
  <div id="logo-div" style="bgcolor:#000000;">
	  <img src="<?php echo base_url();?>source/admin/images/ecshop_logo.gif" alt="ECSHOP - power for e-commerce"></div>
  ...
  <div id="submenu-div">
    ...
    <div id="send_info" style="padding: 5px 10px 0 0; clear:right;text-align: right; color: #FF9900;width:40%;float: right;">
            <a href="http://www.lazy360.com/admin/index.php?act=clear_cache" target="main-frame" class="fix-submenu">清除缓存</a>
      <a href="<?php echo site_url('admin/logout');?>" target="_top" class="fix-submenu">退出</a>
    </div>
  </div>
</div>
<div id="menu-div">
